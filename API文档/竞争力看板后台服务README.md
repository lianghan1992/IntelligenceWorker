...
## **竞争力看板 - 用户操作手册（示例！！！目的是帮助研发阶段理解后台的运行逻辑）**

欢迎使用竞争力看板！这是一个强大的AI助手，旨在帮助您轻松地从海量行业资讯中，自动构建和维护您自己的竞争情报数据库。

### **第一章：理解系统的核心逻辑**

您可以把整个系统想象成一个高度智能化的**“图书馆 + 档案馆”**。

1.  **第一步：建立“书架分类法”（定义您关心什么）**
    *   您首先需要告诉系统，您的图书馆准备收藏关于哪些**主题**的书，以及每本书里需要记录哪些**关键信息**。这个过程我们称之为“**设计看板模块**”。
    *   例如，您可以设计一个叫“**新技术**”的书架，并规定每本关于新技术的书，都必须记录“**技术名称**”、“**成熟度**”和“**可信度**”这三项信息。

2.  **第二步：AI当图书管理员（自动收集和整理）**
    *   一旦您定义好了“分类法”，AI就会像一个不知疲倦的图书管理员，开始阅读每天抓取的所有新文章。
    *   当AI读到一篇关于“小米SU7固态电池”的文章时，它会：
        *   **初步记录**：先在一张草稿纸上写下：“发现一条关于‘小米SU7’的‘新技术’线索。” (这就是`cdash_raw_findings`表的作用)
        *   **正式归档**: 然后，它会拿出您设计的“新技术”空白卡片，将文章中的信息填进去。同时，它会去档案馆里查找之前是否已经有关于“小米SU7固态电池”的记录。
            *   **如果是全新的**，它会把这张新卡片存入档案馆。
            *   **如果已经有了**，它会对比新旧信息，用更可靠、更详细的新信息**更新**档案馆里的旧卡片。
        *   这个最终的、干净的档案馆，就是我们系统里以`cdash_data_`开头的各种表。

3.  **第三步：您来查阅最终成果（查看看板）**
    *   您在前端页面上看到的，永远是那个经过AI精心整理和实时更新的、最干净的“档案馆”里的最终成果。

---

### **第二章：核心模块操作指南**

您的日常工作，主要会围绕以下几个核心模块展开。

#### **模块一：实体库 (Entities)**

*   **这是什么？**
    *   这是您整个情报系统的“**通讯录**”或“**名词词典**”。它告诉系统，世界上有“小米汽车”、“理想L9”、“宁德时代”这些您关心的具体事物。**AI只有认识了这些“名词”，才能为您工作。**

*   **有什么关系？**
    *   **它是所有情报的基础**。所有的数据最终都会关联到某个“实体”上。没有它，AI就不知道情报是关于谁的。

*   **您该怎么做？**
    1.  **日常维护**: 当市场上出现一个新的竞争对手（如“极越汽车”）或一款新车时，您需要做的第一件事，就是来这里“**新建实体**”，把它加入到您的“通讯录”里。
    2.  **信息补充**: 您可以为每个实体添加“**别名**”（比如为“小米SU7”添加“米车”），这能帮助AI更准确地识别文章内容。您也可以在“元数据”里记录一些静态信息，如成立年份、总部地点等。

#### **模块二：看板模块 (Modules)**

*   **这是什么？**
    *   这就是您设计的**“空白信息卡片”模板**。您在这里定义一个全新的业务分析维度。

*   **有什么关系？**
    *   **它是AI工作的“指导手册”**。您在这里定义了什么，AI就会去文章里寻找什么。

*   **您该怎么做？ (核心操作)**
    1.  **创建新看板**: 当您想开辟一个新的分析领域，比如“**市场营销活动**”时，您就来这里“**新建模块**”。
    2.  **定义“表头”**: 在创建时，最关键的一步是“**添加字段**”。您需要为您想追踪的每一项信息都定义一个字段。例如，对于“市场营销活动”，您可以添加：
        *   `活动名称`: 指示AI去提取营销活动的名字。
        *   `活动时间`: 指示AI去提取活动的起止日期。
        *   `核心卖点`: 指示AI去总结这次活动主要宣传了什么。
    3.  **激活模块**: 保存并激活后，AI就会立即开始按照您设计的这张新的“市场营销活动”卡片，去阅读和填充信息了。

#### **模块三：数据看板 (Dashboard)**

*   **这是什么？**
    *   这就是您在前端看到的、最终的、图文并茂的**情报展示页面**。

*   **有什么关系？**
    *   它**消费**和**展示**由“实体库”和“看板模块”共同作用下，由AI自动填充的最终数据。

*   **您该怎么做？**
    1.  **筛选查看**: 您可以通过顶部的筛选器，选择您想看的“实体”（如只看“小米汽车”和“理想汽车”）。
    2.  **分析洞察**: 您可以直观地看到每个实体，在您定义的每个“技术维度”（智能驾驶、智能座舱...）下，有哪些最新的技术动态。
    3.  **追溯历史 (故事线)**: 当您对某个具体的技术卡片（如“城市NOA”）的来龙去脉感兴趣时，可以点击它，查看它的“**演进历史**”。系统会为您呈现一条“故事线”，展示这个信息从最初的“传闻”，到后来被“证实”的全过程，以及每次信息更新的来源是哪篇文章。

---

### **第三章：理解后台的数据表（非技术人员版）**

您不需要直接操作数据库，但理解这些表的作用，能帮助您更好地理解系统是如何工作的。

*   **`cdash_modules` (您的“模板库”)**
    *   **一句话解释**: 这张表存放了您在“看板模块”后台设计的所有“**空白卡片模板**”。
    *   **它有什么用**: AI每次工作前，都会先来这里看看，有哪些模板需要它去填写。

*   **`cdash_raw_findings` (AI的“草稿纸”)**
    *   **一句话解释**: 这是AI的**“初步观察记录本”**。AI每从一篇文章里发现一条可能的线索，都会先潦草地记在这里。
    *   **它有什么用**: 这里的数据可能是重复的、甚至有错误的。它的存在，是为了保证我们不错过任何一条线索，并且为后续的“精加工”提供原材料。

*   **`cdash_data_technology` (及其他`cdash_data_`表) (最终的“档案馆”)**
    *   **一句话解释**: 这是经过AI和系统**最终确认、整理、去重**后的**“干净档案库”**。
    *   **它有什么用**: **您在前端看到的所有技术卡片，都直接来源于这张表**。它永远只保存每个技术点最新的、最可信的状态。

*   **`cdash_evolution_chains` (档案馆里的“索引绳”)**
    *   **一句话解释**: 这是一张特殊的索引表，它用一条无形的绳子，把AI“草稿纸”上关于同一个主题的所有记录，和“档案馆”里最终的那条记录**串联**了起来。
    *   **它有什么用**: 当您想看某个技术的“故事线”时，系统就是通过这根“绳子”，快速地为您找到了所有相关的历史记录。

希望这份从业务逻辑出发的手册，能让您对整个系统的运作有一个清晰、直观的理解。您的核心工作，就是在“实体库”和“看板模块”中，将您的行业智慧和分析框架“教会”给系统，剩下的就交给AI和自动化流程来完成。