...
import { CheckIcon, DocumentTextIcon, ArrowRightIcon, PencilIcon } from '../icons';
             ...
             <div className="flex-1 overflow-y-auto p-8 custom-scrollbar pb-32">
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                    {outlineData.pages.map((page, idx) => (
                         <div key={idx} className="group bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-indigo-300 transition-all relative overflow-hidden flex flex-col h-full">
