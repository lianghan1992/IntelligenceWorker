...
export const ContentStep: React.FC<{
    ...
    useEffect(() => {
        ...
        const processPage = async (page: StratifyPage) => {
            ...
            await streamGenerate(
                {
                    prompt_name: '03_generate_content',
                    variables: {
    ...
    return (
        <div className="flex h-full bg-[#f8fafc] overflow-hidden relative">
            <ReasoningModal isOpen={isThinkingOpen} onClose={() => setIsThinkingOpen(false)} content={reasoningStream || pageThought} status="AI 正在深度思考..." />
