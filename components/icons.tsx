...
export const FilmIcon = createIcon(
    <path fillRule="evenodd" d="M1.75 2A1.75 1.75 0 000 3.75v12.5C0 17.216.784 18 1.75 18h16.5A1.75 1.75 0 0020 16.25V3.75A1.75 1.75 0 0018.25 2H1.75zM2.5 4.5a.25.25 0 01.25-.25h2.5a.25.25 0 01.25.25v11a.25.25 0 01-.25.25h-2.5a.25.25 0 01-.25-.25v-11zm12.5 0a.25.25 0 01.25-.25h2.5a.25.25 0 01.25.25v11a.25.25 0 01-.25.25h-2.5a.25.25 0 01-.25-.25v-11zM7.5 4a.5.5 0 00-1 .5v2a.5.5 0 001 .5h5a.5.5 0 00.5-.5v-2a.5.5 0 00-.5-.5h-5zM6.5 10a.5.5 0 01.5-.5h5a.5.5 0 01.5.5v2a.5.5 0 01-.5.5h-5a.5.5 0 01-.5-.5v-2z" clipRule="evenodd" />
);

export const PhotoIcon = createIcon(
    <path fillRule="evenodd" d="M1.5 3A1.5 1.5 0 000 4.5v11A1.5 1.5 0 001.5 17h17a1.5 1.5 0 001.5-1.5v-11A1.5 1.5 0 0018.5 3H1.5zM6 7a2 2 0 100 4 2 2 0 000-4zm4.293 2.293a1 1 0 00-1.414-1.414l-6 6a1 1 0 000 1.414l2.5 2.5a1 1 0 001.414 0l7-7a1 1 0 000-1.414l-3.5-3.5z" clipRule="evenodd" />
);
