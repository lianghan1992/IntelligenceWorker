...
export const FireIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props} viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M12.316 3.051a1.5 1.5 0 01.063 2.122l-2.022 2.871c.216.096.42.22.607.368l2.73-3.896a1.5 1.5 0 012.122-.063l.995.995a1.5 1.5 0 01-.063 2.122l-2.09 2.982c.45.32.793.728 1.056 1.188l2.982-2.09a1.5 1.5 0 012.122.063l.995.995a1.5 1.5 0 01-.063 2.122l-.995-.995a1.5 1.5 0 01.063-2.122l2.73-3.896a6.47 6.47 0 011.248-1.272L3.05 5.234a1.5 1.5 0 01.063-2.122l.995-.995a1.5 1.5 0 012.122.063l2.022 2.871c.28-.148.574-.268.88-.354l.94-1.978a1.5 1.5 0 012.83 0l.94 1.978c.306.086.6.206.88.354l2.022-2.871a1.5 1.5 0 012.122-.063l.995.995z" clipRule="evenodd" />
    </Icon>
);
